...
<ul id="slide-out" class="sidenav sidenav-fixed">
  <li style="height: auto;">
    <div class="user-view" style="width: 100%;">
      <div class="row center">
        <div class="col s12">
          <img src="../docs/images/logo-energuate.png" style="width: 90%; height: auto;" />
        </div>
      </div>
    </div>
  </li>
  ...
  <li><a id="n1" href="./index.php"><i id="i1" class="material-icons">insert_chart</i>Dashboards</a></li>
  <!-- <li><a id="n2" class="truncate" href="./alta_usuario.php"><i id="i2" class="material-icons">blur_circular</i>Datos</a></li> -->
  <li><a id="n2" class="truncate" href="./verificar_codigo.php"><i id="i2" class="material-icons">blur_circular</i>Datos</a></li>

  <li>
    <a id="n9" href="./usuario.php">
      <i id="i9" class="material-icons">person_outline</i>
      Usuario
    </a>
  </li>

  <li><a id="n4" href="../controller/assets/salir.php"><i id="i5" class="material-icons">close</i>Salir</a>
